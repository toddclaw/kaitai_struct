...
-- field declarations
f.transaction_id = ProtoField.bytes("dns_packet.transaction_id", "transaction_id")
f.flags = ProtoField.bytes("dns_packet.flags", "flags")
f.qdcount = ProtoField.bytes("dns_packet.qdcount", "qdcount")
f.ancount = ProtoField.bytes("dns_packet.ancount", "ancount")
f.nscount = ProtoField.bytes("dns_packet.nscount", "nscount")
f.arcount = ProtoField.bytes("dns_packet.arcount", "arcount")
f.queries = ProtoField.bytes("dns_packet.queries", "queries")
f.answers = ProtoField.bytes("dns_packet.answers", "answers")
f.authorities = ProtoField.bytes("dns_packet.authorities", "authorities")
f.additionals = ProtoField.bytes("dns_packet.additionals", "additionals")
f.name = ProtoField.bytes("dns_packet.query.name", "name")
f.type = ProtoField.bytes("dns_packet.query.type", "type")
f.query_class = ProtoField.bytes("dns_packet.query.query_class", "query_class")
f.name = ProtoField.bytes("dns_packet.answer.name", "name")
f.type = ProtoField.bytes("dns_packet.answer.type", "type")
f.answer_class = ProtoField.bytes("dns_packet.answer.answer_class", "answer_class")
f.ttl = ProtoField.bytes("dns_packet.answer.ttl", "ttl")
f.rdlength = ProtoField.bytes("dns_packet.answer.rdlength", "rdlength")
f.payload = ProtoField.bytes("dns_packet.answer.payload", "payload")
f.name = ProtoField.bytes("dns_packet.domain_name.name", "name")
f.length = ProtoField.bytes("dns_packet.label.length", "length")
f.pointer = ProtoField.bytes("dns_packet.label.pointer", "pointer")
f.name = ProtoField.bytes("dns_packet.label.name", "name")
f.value = ProtoField.bytes("dns_packet.pointer_struct.value", "value")
f.ip = ProtoField.bytes("dns_packet.address.ip", "ip")
f.ip_v6 = ProtoField.bytes("dns_packet.address_v6.ip_v6", "ip_v6")
f.flag = ProtoField.bytes("dns_packet.packet_flags.flag", "flag")
f.priority = ProtoField.bytes("dns_packet.service.priority", "priority")
f.weight = ProtoField.bytes("dns_packet.service.weight", "weight")
f.port = ProtoField.bytes("dns_packet.service.port", "port")
f.target = ProtoField.bytes("dns_packet.service.target", "target")
f.length = ProtoField.bytes("dns_packet.txt.length", "length")
f.text = ProtoField.bytes("dns_packet.txt.text", "text")
f.data = ProtoField.bytes("dns_packet.txt_body.data", "data")
f.primary_ns = ProtoField.bytes("dns_packet.authority_info.primary_ns", "primary_ns")
f.resoponsible_mailbox = ProtoField.bytes("dns_packet.authority_info.resoponsible_mailbox", "resoponsible_mailbox")
f.serial = ProtoField.bytes("dns_packet.authority_info.serial", "serial")
f.refresh_interval = ProtoField.bytes("dns_packet.authority_info.refresh_interval", "refresh_interval")
f.retry_interval = ProtoField.bytes("dns_packet.authority_info.retry_interval", "retry_interval")
f.expire_limit = ProtoField.bytes("dns_packet.authority_info.expire_limit", "expire_limit")
f.min_ttl = ProtoField.bytes("dns_packet.authority_info.min_ttl", "min_ttl")
f.preference = ProtoField.bytes("dns_packet.mx_info.preference", "preference")
f.mx = ProtoField.bytes("dns_packet.mx_info.mx", "mx")
