...
-- field declarations
f.version = ProtoField.bytes("kaitai_tls_client_hello.version", "version")
f.random = ProtoField.bytes("kaitai_tls_client_hello.random", "random")
f.session_id = ProtoField.bytes("kaitai_tls_client_hello.session_id", "session_id")
f.cipher_suites = ProtoField.bytes("kaitai_tls_client_hello.cipher_suites", "cipher_suites")
f.compression_methods = ProtoField.bytes("kaitai_tls_client_hello.compression_methods", "compression_methods")
f.extensions = ProtoField.bytes("kaitai_tls_client_hello.extensions", "extensions")
f.major = ProtoField.bytes("kaitai_tls_client_hello.version.major", "major")
f.minor = ProtoField.bytes("kaitai_tls_client_hello.version.minor", "minor")
f.gmt_unix_time = ProtoField.bytes("kaitai_tls_client_hello.random.gmt_unix_time", "gmt_unix_time")
f.random = ProtoField.bytes("kaitai_tls_client_hello.random.random", "random")
f.len = ProtoField.bytes("kaitai_tls_client_hello.session_id.len", "len")
f.sid = ProtoField.bytes("kaitai_tls_client_hello.session_id.sid", "sid")
f.len = ProtoField.bytes("kaitai_tls_client_hello.cipher_suites.len", "len")
f.cipher_suites = ProtoField.bytes("kaitai_tls_client_hello.cipher_suites.cipher_suites", "cipher_suites")
f.len = ProtoField.bytes("kaitai_tls_client_hello.compression_methods.len", "len")
f.compression_methods = ProtoField.bytes("kaitai_tls_client_hello.compression_methods.compression_methods", "compression_methods")
f.len = ProtoField.bytes("kaitai_tls_client_hello.extensions.len", "len")
f.extensions = ProtoField.bytes("kaitai_tls_client_hello.extensions.extensions", "extensions")
f.type = ProtoField.bytes("kaitai_tls_client_hello.extension.type", "type")
f.len = ProtoField.bytes("kaitai_tls_client_hello.extension.len", "len")
f.body = ProtoField.bytes("kaitai_tls_client_hello.extension.body", "body")
f.list_length = ProtoField.bytes("kaitai_tls_client_hello.sni.list_length", "list_length")
f.server_names = ProtoField.bytes("kaitai_tls_client_hello.sni.server_names", "server_names")
f.name_type = ProtoField.bytes("kaitai_tls_client_hello.server_name.name_type", "name_type")
f.length = ProtoField.bytes("kaitai_tls_client_hello.server_name.length", "length")
f.host_name = ProtoField.bytes("kaitai_tls_client_hello.server_name.host_name", "host_name")
f.ext_len = ProtoField.bytes("kaitai_tls_client_hello.alpn.ext_len", "ext_len")
f.alpn_protocols = ProtoField.bytes("kaitai_tls_client_hello.alpn.alpn_protocols", "alpn_protocols")
f.strlen = ProtoField.bytes("kaitai_tls_client_hello.protocol.strlen", "strlen")
f.name = ProtoField.bytes("kaitai_tls_client_hello.protocol.name", "name")
