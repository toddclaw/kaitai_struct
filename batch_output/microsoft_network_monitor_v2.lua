...
-- field declarations
f.signature = ProtoField.bytes("kaitai_microsoft_network_monitor_v2.signature", "signature")
f.version_minor = ProtoField.bytes("kaitai_microsoft_network_monitor_v2.version_minor", "version_minor")
f.version_major = ProtoField.bytes("kaitai_microsoft_network_monitor_v2.version_major", "version_major")
f.mac_type = ProtoField.bytes("kaitai_microsoft_network_monitor_v2.mac_type", "mac_type")
f.time_capture_start = ProtoField.bytes("kaitai_microsoft_network_monitor_v2.time_capture_start", "time_capture_start")
f.frame_table_ofs = ProtoField.bytes("kaitai_microsoft_network_monitor_v2.frame_table_ofs", "frame_table_ofs")
f.frame_table_len = ProtoField.bytes("kaitai_microsoft_network_monitor_v2.frame_table_len", "frame_table_len")
f.user_data_ofs = ProtoField.bytes("kaitai_microsoft_network_monitor_v2.user_data_ofs", "user_data_ofs")
f.user_data_len = ProtoField.bytes("kaitai_microsoft_network_monitor_v2.user_data_len", "user_data_len")
f.comment_ofs = ProtoField.bytes("kaitai_microsoft_network_monitor_v2.comment_ofs", "comment_ofs")
f.comment_len = ProtoField.bytes("kaitai_microsoft_network_monitor_v2.comment_len", "comment_len")
f.statistics_ofs = ProtoField.bytes("kaitai_microsoft_network_monitor_v2.statistics_ofs", "statistics_ofs")
f.statistics_len = ProtoField.bytes("kaitai_microsoft_network_monitor_v2.statistics_len", "statistics_len")
f.network_info_ofs = ProtoField.bytes("kaitai_microsoft_network_monitor_v2.network_info_ofs", "network_info_ofs")
f.network_info_len = ProtoField.bytes("kaitai_microsoft_network_monitor_v2.network_info_len", "network_info_len")
f.conversation_stats_ofs = ProtoField.bytes("kaitai_microsoft_network_monitor_v2.conversation_stats_ofs", "conversation_stats_ofs")
f.conversation_stats_len = ProtoField.bytes("kaitai_microsoft_network_monitor_v2.conversation_stats_len", "conversation_stats_len")
f.entries = ProtoField.bytes("kaitai_microsoft_network_monitor_v2.frame_index.entries", "entries")
f.ofs = ProtoField.bytes("kaitai_microsoft_network_monitor_v2.frame_index_entry.ofs", "ofs")
f.ts_delta = ProtoField.bytes("kaitai_microsoft_network_monitor_v2.frame.ts_delta", "ts_delta")
f.orig_len = ProtoField.bytes("kaitai_microsoft_network_monitor_v2.frame.orig_len", "orig_len")
f.inc_len = ProtoField.bytes("kaitai_microsoft_network_monitor_v2.frame.inc_len", "inc_len")
f.body = ProtoField.bytes("kaitai_microsoft_network_monitor_v2.frame.body", "body")
