...
-- field declarations
f.icmp_type = ProtoField.bytes("icmp_packet.icmp_type", "icmp_type")
f.destination_unreachable = ProtoField.bytes("icmp_packet.destination_unreachable", "destination_unreachable")
f.time_exceeded = ProtoField.bytes("icmp_packet.time_exceeded", "time_exceeded")
f.echo = ProtoField.bytes("icmp_packet.echo", "echo")
f.code = ProtoField.bytes("icmp_packet.destination_unreachable_msg.code", "code")
f.checksum = ProtoField.bytes("icmp_packet.destination_unreachable_msg.checksum", "checksum")
f.code = ProtoField.bytes("icmp_packet.time_exceeded_msg.code", "code")
f.checksum = ProtoField.bytes("icmp_packet.time_exceeded_msg.checksum", "checksum")
f.code = ProtoField.bytes("icmp_packet.echo_msg.code", "code")
f.checksum = ProtoField.bytes("icmp_packet.echo_msg.checksum", "checksum")
f.identifier = ProtoField.bytes("icmp_packet.echo_msg.identifier", "identifier")
f.seq_num = ProtoField.bytes("icmp_packet.echo_msg.seq_num", "seq_num")
f.data = ProtoField.bytes("icmp_packet.echo_msg.data", "data")
