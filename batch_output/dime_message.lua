...
-- field declarations
f.records = ProtoField.bytes("kaitai_dime_message.records", "records")
f.boundary_padding = ProtoField.bytes("kaitai_dime_message.padding.boundary_padding", "boundary_padding")
f.option_elements = ProtoField.bytes("kaitai_dime_message.option_field.option_elements", "option_elements")
f.element_format = ProtoField.bytes("kaitai_dime_message.option_element.element_format", "element_format")
f.len_element = ProtoField.bytes("kaitai_dime_message.option_element.len_element", "len_element")
f.element_data = ProtoField.bytes("kaitai_dime_message.option_element.element_data", "element_data")
f.version = ProtoField.bytes("kaitai_dime_message.record.version", "version")
f.is_first_record = ProtoField.bytes("kaitai_dime_message.record.is_first_record", "is_first_record")
f.is_last_record = ProtoField.bytes("kaitai_dime_message.record.is_last_record", "is_last_record")
f.is_chunk_record = ProtoField.bytes("kaitai_dime_message.record.is_chunk_record", "is_chunk_record")
f.type_format = ProtoField.bytes("kaitai_dime_message.record.type_format", "type_format")
f.reserved = ProtoField.bytes("kaitai_dime_message.record.reserved", "reserved")
f.len_options = ProtoField.bytes("kaitai_dime_message.record.len_options", "len_options")
f.len_id = ProtoField.bytes("kaitai_dime_message.record.len_id", "len_id")
f.len_type = ProtoField.bytes("kaitai_dime_message.record.len_type", "len_type")
f.len_data = ProtoField.bytes("kaitai_dime_message.record.len_data", "len_data")
f.options = ProtoField.bytes("kaitai_dime_message.record.options", "options")
f.options_padding = ProtoField.bytes("kaitai_dime_message.record.options_padding", "options_padding")
f.id = ProtoField.bytes("kaitai_dime_message.record.id", "id")
f.id_padding = ProtoField.bytes("kaitai_dime_message.record.id_padding", "id_padding")
f.type = ProtoField.bytes("kaitai_dime_message.record.type", "type")
f.type_padding = ProtoField.bytes("kaitai_dime_message.record.type_padding", "type_padding")
f.data = ProtoField.bytes("kaitai_dime_message.record.data", "data")
f.data_padding = ProtoField.bytes("kaitai_dime_message.record.data_padding", "data_padding")
