...
-- field declarations
f.initial_frame = ProtoField.bytes("kaitai_websocket.initial_frame", "initial_frame")
f.trailing_frames = ProtoField.bytes("kaitai_websocket.trailing_frames", "trailing_frames")
f.finished = ProtoField.bytes("kaitai_websocket.frame_header.finished", "finished")
f.reserved = ProtoField.bytes("kaitai_websocket.frame_header.reserved", "reserved")
f.opcode = ProtoField.bytes("kaitai_websocket.frame_header.opcode", "opcode")
f.is_masked = ProtoField.bytes("kaitai_websocket.frame_header.is_masked", "is_masked")
f.len_payload_primary = ProtoField.bytes("kaitai_websocket.frame_header.len_payload_primary", "len_payload_primary")
f.len_payload_extended_1 = ProtoField.bytes("kaitai_websocket.frame_header.len_payload_extended_1", "len_payload_extended_1")
f.len_payload_extended_2 = ProtoField.bytes("kaitai_websocket.frame_header.len_payload_extended_2", "len_payload_extended_2")
f.mask_key = ProtoField.bytes("kaitai_websocket.frame_header.mask_key", "mask_key")
f.header = ProtoField.bytes("kaitai_websocket.initial_frame.header", "header")
f.payload_bytes = ProtoField.bytes("kaitai_websocket.initial_frame.payload_bytes", "payload_bytes")
f.payload_text = ProtoField.bytes("kaitai_websocket.initial_frame.payload_text", "payload_text")
f.header = ProtoField.bytes("kaitai_websocket.dataframe.header", "header")
f.payload_bytes = ProtoField.bytes("kaitai_websocket.dataframe.payload_bytes", "payload_bytes")
f.payload_text = ProtoField.bytes("kaitai_websocket.dataframe.payload_text", "payload_text")
