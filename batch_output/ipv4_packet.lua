...
-- field declarations
f.b1 = ProtoField.bytes("ipv4_packet.b1", "b1")
f.b2 = ProtoField.bytes("ipv4_packet.b2", "b2")
f.total_length = ProtoField.bytes("ipv4_packet.total_length", "total_length")
f.identification = ProtoField.bytes("ipv4_packet.identification", "identification")
f.b67 = ProtoField.bytes("ipv4_packet.b67", "b67")
f.ttl = ProtoField.bytes("ipv4_packet.ttl", "ttl")
f.protocol = ProtoField.bytes("ipv4_packet.protocol", "protocol")
f.header_checksum = ProtoField.bytes("ipv4_packet.header_checksum", "header_checksum")
f.src_ip_addr = ProtoField.bytes("ipv4_packet.src_ip_addr", "src_ip_addr")
f.dst_ip_addr = ProtoField.bytes("ipv4_packet.dst_ip_addr", "dst_ip_addr")
f.options = ProtoField.bytes("ipv4_packet.options", "options")
f.body = ProtoField.bytes("ipv4_packet.body", "body")
f.entries = ProtoField.bytes("ipv4_packet.ipv4_options.entries", "entries")
f.b1 = ProtoField.bytes("ipv4_packet.ipv4_option.b1", "b1")
f.len = ProtoField.bytes("ipv4_packet.ipv4_option.len", "len")
f.body = ProtoField.bytes("ipv4_packet.ipv4_option.body", "body")
