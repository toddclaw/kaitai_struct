...
-- field declarations
f.version = ProtoField.bytes("bitcoin_transaction.version", "version")
f.num_vins = ProtoField.bytes("bitcoin_transaction.num_vins", "num_vins")
f.vins = ProtoField.bytes("bitcoin_transaction.vins", "vins")
f.num_vouts = ProtoField.bytes("bitcoin_transaction.num_vouts", "num_vouts")
f.vouts = ProtoField.bytes("bitcoin_transaction.vouts", "vouts")
f.locktime = ProtoField.bytes("bitcoin_transaction.locktime", "locktime")
f.txid = ProtoField.bytes("bitcoin_transaction.vin.txid", "txid")
f.output_id = ProtoField.bytes("bitcoin_transaction.vin.output_id", "output_id")
f.len_script = ProtoField.bytes("bitcoin_transaction.vin.len_script", "len_script")
f.script_sig = ProtoField.bytes("bitcoin_transaction.vin.script_sig", "script_sig")
f.end_of_vin = ProtoField.bytes("bitcoin_transaction.vin.end_of_vin", "end_of_vin")
f.amount = ProtoField.bytes("bitcoin_transaction.vout.amount", "amount")
f.len_script = ProtoField.bytes("bitcoin_transaction.vout.len_script", "len_script")
f.script_pub_key = ProtoField.bytes("bitcoin_transaction.vout.script_pub_key", "script_pub_key")
