...
-- field declarations
f.body = ProtoField.bytes("kaitai_protocol_body.body", "body")
f.next_header_type = ProtoField.bytes("kaitai_protocol_body.option_hop_by_hop.next_header_type", "next_header_type")
f.hdr_ext_len = ProtoField.bytes("kaitai_protocol_body.option_hop_by_hop.hdr_ext_len", "hdr_ext_len")
f.body = ProtoField.bytes("kaitai_protocol_body.option_hop_by_hop.body", "body")
f.next_header = ProtoField.bytes("kaitai_protocol_body.option_hop_by_hop.next_header", "next_header")
