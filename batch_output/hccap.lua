...
-- field declarations
f.records = ProtoField.bytes("kaitai_hccap.records", "records")
f.essid = ProtoField.bytes("kaitai_hccap.hccap_record.essid", "essid")
f.mac_ap = ProtoField.bytes("kaitai_hccap.hccap_record.mac_ap", "mac_ap")
f.mac_station = ProtoField.bytes("kaitai_hccap.hccap_record.mac_station", "mac_station")
f.nonce_station = ProtoField.bytes("kaitai_hccap.hccap_record.nonce_station", "nonce_station")
f.nonce_ap = ProtoField.bytes("kaitai_hccap.hccap_record.nonce_ap", "nonce_ap")
f.eapol_buffer = ProtoField.bytes("kaitai_hccap.hccap_record.eapol_buffer", "eapol_buffer")
f.len_eapol = ProtoField.bytes("kaitai_hccap.hccap_record.len_eapol", "len_eapol")
f.keyver = ProtoField.bytes("kaitai_hccap.hccap_record.keyver", "keyver")
f.keymic = ProtoField.bytes("kaitai_hccap.hccap_record.keymic", "keymic")
